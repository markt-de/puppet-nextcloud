...
### Changed
* Abort update attempt if a lock file can be found

## [v1.13.0] - 2025-04-14

### Added
* Add new parameter `$exec_timeout`

### Changed
* Increase timeout for exec resources from 300 to 3600 seconds
...
[Unreleased]: https://github.com/markt-de/puppet-nextcloud/compare/v1.14.0...HEAD
[v1.14.0]: https://github.com/markt-de/puppet-nextcloud/compare/v1.13.0...v1.14.0
[v1.13.0]: https://github.com/markt-de/puppet-nextcloud/compare/v1.12.0...v1.13.0
